...
class pydualsense:
    ...
    def setBothMotors(self, intensity: int):
        """
            set rumble for both vibration motors
            ...
            Raises:
                ...
                Exception: intensity out of bounds 0..255
        """
        self.setRightMotor(intensity)
        self.setLeftMotor(intensity)
    ...
    def prepareReport(self):
        ...
        # 0x80 ???
        outReport[2] = 0x01 | 0x02 | 0x04 | 0x10 | 0x40 # [2]
